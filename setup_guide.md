...
_If you're looking at this in Cursor/VS_code, please right click on the filename in the Explorer on the left, and select "Open preview", to view the formatted version._
...
### If you face any problems : Visit here / Otherwise leave here :
...
3. Click "Open project / Select NEW Folder to work with..."  
4. When your project opens, you may be prompted to "install recommended extensions" for Python and Jupyter. If so, choose Yes! Otherwise:
- Open extensions (View >> extensions)
- Search for python, and when the results show, click on the ms-python one, and Install it if not already installed
- Search for jupyter, and when the results show, click on the Microsoft one, and Install it if not already installed

Now open the Explorer (View >> Explorer) and Cursor should show each of the file explorer on the left.
...
Finally, run these commands to be ready to use CrewAI for Backend - but please note that this needs you to have installed Microsoft Build Tools (#4 in the 'gotchas' section at the top of this doc):  
...
### Part 4: OpenAI Key ( Optional Only... If Insterested to learn, how ai generates things, read further.....) 
